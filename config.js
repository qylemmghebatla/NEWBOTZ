...
global.sgh = 'https://github.com/carisendiri' // github
...
global.tautanwa = 'https://wa.me/message/60177302593'
global.wame = 'https://wa.me/message/60177302593' // kalau gk punya bisa ganti pake gini wa.me/6283133329293
...
global.nomorown1 = '601137009378' //pake No Pacar lo Juga Boleh
global.namebot = '✧ ˖ ࣪ ‹  𝕼𝖞𝖑𝖊𝕭𝖔𝖙𝖟 🐻 𖥔 ࣪ ᥫ᭡'
global.nameown = 'QYLE'
global.nameown1 = 'IZZAT' //Pake Nama Pacar Lo Juga Boleh

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/jstme._____' // ig lo
global.sigpcr = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/degantengxprettytroops' // ig cewek lo
/*============== Github Thanks To ==============*/
...
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝕼𝖞𝖑𝖊𝕭𝖔𝖙𝖟 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 𝕼𝖞𝖑𝖊𝕭𝖔𝖙𝖟 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By ZYKO MD`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 𝕼𝖞𝖑𝖊𝕭𝖔𝖙𝖟  あ」'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["✘ 𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","⚠️ 𝘼𝙘𝙘𝙨𝙚𝙨 𝘿𝙖𝙣𝙞𝙚𝙙 ⚠️"])

/*============== STICKER WM ==============*/
global.stickpack = '𝕼𝖞𝖑𝖊𝕭𝖔𝖙𝖟'
global.stickauth = `By ©ZYKO MD`
 
/*============== LOGO ==============*/
global.fotonya1 = 'https://telegra.ph/file/7a3c2975aac8cc97f35c3.jpg' 
global.fotonya2 = 'https://telegra.ph/file/7a3c2975aac8cc97f35c3.jpg'
